...
export const useSpotifyAPI = (user) => {
  ...
  const setSpotifyUserInfo = (token) => {
    spotifyService.getUserInfo(token).then((data) => {
      errorHandling(data);

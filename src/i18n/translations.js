export default {
  pt: {
    "home.title": "Widget do spotify para OBS",
    "login_button.text": "Conectar com spotify",
    "what_is.title": "O que é?",
    "what_is.text":
      "Um widget que mostra o que está tocando atualmente no seu spotify. Foi construído para ser utilizado com o OBS Studio ou Streamlabs OBS (ou outro aplicativo de broadcast que aceite fontes de url). Desta forma, quem está assistindo sua live, sabe que música está tocando.",
  ...
  en: {
    "home.title": "Spotify widget for OBS",
    "login_button.text": "Connect with spotify",
    "what_is.title": "What is?",
    "what_is.text":
